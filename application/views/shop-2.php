            ...
            <ul>
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="active-item"><a href="shop-2.html">THREE COLUMNS </a></li>
                    </ul>
                </li>
...
<div id="page" class="site invisible">
    ...
    <div class="site-main clearfix">
        <div class="shop-product-list shop-product-list-3-columns clearfix col-sm-12">
            <div class="row">
                <div class="col-sm-12">
